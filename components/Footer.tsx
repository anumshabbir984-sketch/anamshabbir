                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-gray-400 mb-4">
                            SEO Expert, Prompt Engineer & Web Developer. Crafting digital experiences that drive results.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start space-x-3">
                                ...
                                <a href="mailto:contact@anamshabbir.com" className="hover:text-primary-400 transition-colors">
                ...
                <div className="pt-8 border-t border-gray-800">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <p className="text-gray-400 text-sm">
                            © {currentYear} Anam Shabbir. All rights reserved.
                        </p>
